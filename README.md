...
Project build as part of the Android App Development course on internshala(Final Project)


Android application for ordering food from available local restaurants
