...
class MyCartActivity : AppCompatActivity() {
    ...
    var totalAmount = 0
    var cartListItems = arrayListOf<com.example.foodapp.model.MenuItems>()
        ...
        btnPlaceOrder.setOnClickListener {
            ...
            if (ConnectionManager().isNetworkAvailable(this)) {
                ...
                try {
                    ...
                    val jsonObjectRequest = object : JsonObjectRequest(Method.POST, url, sendOrder, Response.Listener {
                        val response = it.getJSONObject("data")
                        val success = response.getBoolean("success")

                        if (success) { Toast.makeText(this, "Order Placed", Toast.LENGTH_SHORT).show()
                        ...
                        if (success) {
                            ...
                            for (i in 0 until data.length()) {
                                ...
                                if (selectedItemsId.contains(cartItem.getString("id"))) {
                                    val menuObject = com.example.foodapp.model.MenuItems(
                                ...
                                menuAdapter = CartRecyclerAdapter(this, cartListItems)
